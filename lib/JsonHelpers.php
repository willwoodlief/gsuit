...
class JsonHelpers {
    ...
    /**
     * @uses JsonHelpers::printStatusJSONAndDie()
     * @param $message mixed
     * @param int $http_code
     ...
     * @return string
     */
    public static function toStringAgnostic($what,$b_cast_bools_as_int = true) {
        if (is_null($what)) {return null;}
    ...
    public static function dataFromString($data_type,$what) {
        ...
        switch ($data_type) {
            ...
            case 'json':
                return JsonHelpers::fromString($what);
            case 'date_time' :
        ...
        switch ($data_type) {
            ...
            case 'json':
                if (is_array($what) || is_null($what)) {
                    return JsonHelpers::toString($what);
                } else {
